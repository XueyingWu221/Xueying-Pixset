...
class DasPredictor(VirtualDatasource):
    ...
    def __getitem__(self, key):
        ...
        s = time.time()
        lidar_sample = self.datasources[self.input_datasource][key]     # 0ms, load datasources # self.input_datasource = 'pixell_bfc_ech'
...
def main(cfg, state, dataset, input_datasource):
    ...
    pf[sensor_name].add_datasource(vds, vds.ds_type)    # pf[pixell_bfc] = object "Pixell" # vds.type = 'box3d-toynet'
